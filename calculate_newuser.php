...
?>
    ...
    debit=price*months+priceemail*num_emails*months+pricescript*months*script+pricedb*months*db+months*(priceextratraffic*(traffic-inittraffic))+months*(priceextraquota*(quota-initquota));
